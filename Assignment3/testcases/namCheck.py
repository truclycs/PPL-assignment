...
class CheckSuite(unittest.TestCase):
    ...
    def test_redeclared_variable_block(self):
        "test_redeclared_variable_block"
        input = """
        int test;
        float main(int test){
            boolean test;
    ...
    def test_redeclared_variable_string(self):
        "test_redeclared_variable_string"
        input = """ 
        void main(){}
        void Main(string k){
            int k[6];
    ...
    def test_redeclared_variable_block_if(self):
        "test_redeclared_variable_block_if"
        input = """ 
        int main(){
            int a;
            a = 5;
    ...
    def test_redeclared_variable_block_elif(self):
        "test_redeclared_variable_block_elif"
        input = """
        void main(){
            int a;
            a = 5;
    ...
    def test_redeclared_variable_block_for_expr(self):
        "test_redeclared_variable_block_for_expr"
        input = """
    ...
    def test_redeclared_variable_block_for_if(self):
        "test_redeclared_variable_block_for_if"
        input = """
        string str;
        int a;
        string main(int c){
    ...
    def test_redeclared_variable_for_for(self):
        "test_redeclared_variable_for_for"
        input = """
        string str;
        int a;
        string main(int c){
    ...
    def test_redeclared_variable_if_for(self):
        "test_redeclared_variable_if_for"
        input = """
        void main(int arg[]){
            if(true){
                int a;
    ...
    def test_redeclared_variable_block_if_if(self):
        "test_redeclared_variable_block_if_if"
    ...
    def test_undeclare_function_in_ifexp(self):
        "test_undeclare_function_in_ifexp"
        input = """
        boolean main(int a){
            boolean b, c, d;
            if(bool(a, b, c, d)){
    ...
    def test_undeclared_function_in_ifstmt(self):
        "test_undeclared_function_in_ifstmt"
        input = """
        int foo(int a){
            if (a > 0){
                return 1;
    ...
    def test_undeclared_function_in_doWhilestmt(self):
        "test_undeclared_function_in_doWhilestmt"
        input = """
        int main(){
            boolean main;
            main = true;
    ...
    def test_undeclared_function_in_Forexp(self):
        "test_undeclared_function_in_Forexp"
        input = """
        string str;
        int a;
        string main(int c){
    ...
    def test_undeclared_function_in_Ifexp(self):
        "test_undeclared_function_in_Ifexp"
        input = """
    ...
    def test_undeclared_function_in_whileexp(self):
        "test_undeclared_function_in_whileexp"
        input = """
        int main(int arg[], int b){
            do{
                return b;
    ...
    def test_redeclared_variable_global(self):
        "test_redeclared_variable_global"
        input = """int c;
        float c;
        int main(){return;}"""
        expect = "Redeclared Variable: c"
    ...
    def test_undeclared_variable_global(self):
        "test_undeclared_variable_global"
        input = """int c;
        void main(){
            b = 5;
        }"""
    ...
    def test_undeclared_identifier_in_return(self):
        "test_undeclared_identifier_in_return"
        input = """
        string main(){
            d = 5;
            return c;
    ...
    def test_undeclared_identifier_call(self):
        "test_undeclared_identifier_call"
        input = """
        int test;
        void main(){
            test = 0;
    ...
    def test_undeclared_identifier_return(self):
        "test_undeclared_identifier_return"
        input = """
        int test;
        void main(){
            foo(test);
    ...
    def test_undeclared_identifier_expIF(self):
        "test_undeclared_identifier_expIF"
        input = """
        int test;
        void main(){
            test = 0;
    ...
    def test_undeclared_identifier_exp(self):
        "test_undeclared_identifier_exp"
        input = """
        int main(){
            return a + 1;
        }"""
    ...
    def test_undeclared_identifier_exp2(self):
        "test_undeclared_identifier_exp2"
        input = """
        int main(){
            int a, b, c, d;
            a = b + 5 / d * 5 - e;
    ...
    def test_TypeMismatchInStatement_if_exp(self):
        "test_TypeMismatchInStatement_if_exp"
        input = """
    ...
    def test_TypeMismatchInStatement_for_exp1(self):
        "test_TypeMismatchInStatement_for_exp1"
        input = """
        void main(int arg[], int c){
            string name;
            name  = "Nguyen Dang Ha Nam";
    ...
    def test_TypeMismatchInStatement_for_exp2(self):
        "test_TypeMismatchInStatement_for_exp2"
        input = """
    ...
    def test_TypeMismatchInStatement_for_exp3(self):
        "test_TypeMismatchInStatement_for_exp3"
        input = """
    ...
    def test_TypeMismatchInStatement_while(self):
        "test_TypeMismatchInStatement_while"
        input = """
        int c;
        int main(){
            float c;
    ...
    def test_TypeMismatchInStatement_return_void(self):
        "test_TypeMismatchInStatement_return_void"
        input = """
        void main(){
            return 1;
        }"""
    ...
    def test_TypeMismatchInStatement_return_int(self):
        "test_TypeMismatchInStatement_return_int"
        input = """
    ...
    def test_TypeMismatchInStatement_return_float(self):
        "test_TypeMismatchInStatement_return_float"
        input = """
        float Return(){return foo();}
        void foo(){return;}
    ...
    def test_TypeMismatchInStatement_return_boolean(self):
        "test_TypeMismatchInStatement_return_boolean"
        input = """
        boolean a;
        boolean c;
    ...
    def test_TypeMismatchInStatement_return_string(self):
        "test_TypeMismatchInStatement_return_string"
        input = """boolean a;
        boolean c;
    ...
    def test_TypeMismatchInStatement_return_void_2(self):
        "test_TypeMismatchInStatement_return_void_2"
        input = """
        void R(int a){
            a = a + 1;
        }
    ...
    def test_TypeMismatchInStatement_return_array_poiter(self):
        "test_TypeMismatchInStatement_return_array_poiter"
        input = """
        int[] main(){
            int a;
            return a;
    ...
    def test_TypeMismatchInStatement_return_array_poiter_2(self):
        "test_TypeMismatchInStatement_return_array_poiter_2"
        input = """
        int[] foo(){
            int a[10];
            a[1] = 2;
    ...
    def test_TypeMismatchInStatement_return_array_type(self):
        "test_TypeMismatchInStatement_return_array_type"
        input = """
        int[] main(){
            boolean b;
            b = true;
    ...
    def test_TypeMismatchInStatement_return_string_2(self):
        "test_TypeMismatchInStatement_return_string_2"
        input = """
    ...
    def test_TypeMismatchInStatement_return_void_3(self):
        "test_TypeMismatchInStatement_return_void_3"
        input = """
        int foo(){return 0;}
        float main(){return 0;}
    ...
    def test_TypeMismatchInExpression_binary_operator(self):
        "test_TypeMismatchInExpression_binary_operator"
        input = """
    ...
    def test_TypeMismatchInExpression_binary_not(self):
        "test_TypeMismatchInExpression_binary_not"
        input = """
        float foo(int a, float b){
            return a + b;
        }
    ...
    def test_TypeMismatchInExpression_binary_and(self):
        "test_TypeMismatchInExpression_binary_and"
        input = """
    ...
    def test_TypeMismatchInExpression_binary_or(self):
        "test_TypeMismatchInExpression_binary_or"
        input = """
    ...
    def test_TypeMismatchInExpression_binary_not_equal(self):
        "test_TypeMismatchInExpression_binary_not_equal"
        input = """
    ...
    def test_TypeMismatchInExpression_binary_assign(self):
        "test_TypeMismatchInExpression_binary_assign"
        input = """
        boolean notEqual(boolean a, boolean b){
            return a != b;
        }
    ...
    def test_TypeMismatchInExpression_binary_assign_2(self):
        "test_TypeMismatchInExpression_binary_assign_2"
        input = """
        void main(){
            int a;
            a = 5;
    ...
    def test_TypeMismatchInExpression_binary_2(self):
        "test_TypeMismatchInExpression_binary_2"
        input = """
        void foo(){
            foo();
        }
    ...
    def test_TypeMismatchInExpression_unary(self):
        "test_TypeMismatchInExpression_unary"
        input = """
        float main(){
            int a;
            a = 5;
    ...
    def test_TypeMismatchInExpression_unary_2(self):
        "test_TypeMismatchInExpression_unary_2"
        input = """
        float main(){
            int a;
            a = 5;
    ...
    def test_Break_Continue_not_in_loop(self):
        "test_Break_Continue_not_in_loop"
        input = """
    ...
    def test_not_left_value_4(self):
        ...
        """
        expect = "Not Left Value: BinaryOp(+,BinaryOp(-,IntLiteral(4),IntLiteral(5)),Id(g))"
        self.assertTrue(TestChecker.test(input,expect,489))

    def test_typemismatch_array_pointer(self):
        "test_typemismatch_array_pointer"
        input = """
        int[] getArr(int a[]){
            int b[10];
            if (b[0] < 10){
    ...
    def test_typemismatch_float_div_float_ret_int(self):
        "test_typemismatch_float_div_float_ret_int"
        input = """
    ...
    def test_typemismatch_int_div_float_ret_float(self):
        "test_typemismatch_int_div_float_ret_float"
        input = """
    ...
    def test_typemismatch_int_div_float_ret_int(self):
        "test_typemismatch_int_div_float_ret_int"
        input = """
    ...
    def test_function_not_return_failer(self):
        "test_function_not_return_failer"
        input = """
        float main(){
            if(true){
                if (true){
